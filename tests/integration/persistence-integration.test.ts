...
describe('Persistence Integration', () => {
  ...
  describe('Persistence Error Handling', () => {
    it('should reject corrupted serialized data', () => {
      // Reinterpreted from "corrupted localStorage": GameManager has no storage
      // layer, so corruption surfaces at fromJSON. Truly malformed JSON cannot be
      // parsed and throws.
